...
| CC-24 | Responsive layout pass — dials wrap awkwardly below ~700px | done | low | Shipped: `useIsNarrow(700)` hook — stacked dials, wrapped rail rows, bigger touch targets, iOS home-screen metas + icon |
